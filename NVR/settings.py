"""
Django settings for NVR project.
...
SECRET_KEY = 'django-insecure-41m-xtqakj&cihy8vq1655wb$3+*6n5itrj)#%g%+ycg1$hbzp'
...
WSGI_APPLICATION = 'NVR.wsgi.application'
